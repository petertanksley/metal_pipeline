...
WEIGHT Neff
SEPARATOR TAB
PROCESS ../input/EUR/ALCP/CLEANED.eur_alcp.gz

# === DESCRIBE AND PROCESS 23andMe SMOK SUMSTATS (MALES) ===
#(THE SECOND INPUT FILE HAS THE SAME FORMAT AND CAN BE PROCESSED IMMEDIATELY)
WEIGHT N
PROCESS ../input/EUR/ALCP/CLEANED.eur_alcp_ukb.gz

# === META-ANALYSIS OF MAIN SUMSTATS (NO UKB) WITH UKB SUMSTATS (NO SIBS)
OUTFILE ../output/CLEANED.eur_alcp_ukb_metal .tbl
